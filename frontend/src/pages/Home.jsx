...
export default function Home() {
  ...
  const targetHref = !authReady ? "#" : user ? "/patients" : "/login";
  const ctaText = !authReady ? "Checking session..." : user ? "Go to Patients" : "Sign in to continue";

  return (
    <main className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden">
      {/* Fondo distinto al navbar: degradado radial en verdes muy suaves */}
      <div
        aria-hidden
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="mt-6">
              <Link
                to={targetHref}
                onClick={(e) => { if (!authReady) e.preventDefault(); }}
          ...
          {/* Right: simple illustration block */}
